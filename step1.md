<h1 style="color:#8b0000">Schritt 1: TestStep1</h1>
...
<table id="invisible">
  <tr>
    ...
    <ul style="list-style-type:none">
      <li><i class="fa fa-check-circle" style="color:green"></i> Punkt 1</li>
      <li><i class="fa fa-check-circle" style="color:green"></i> Punkt 2</li>
      <li><i class="fa fa-check-circle" style="color:green"></i> Punkt 3</li>
    </ul></td>
  </tr>
</table>
